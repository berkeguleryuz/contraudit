...
export function PulseBeamsButton({ label }: Props) {
  return (
    <div className="relative flex h-[20rem] w-full items-center justify-center overflow-hidden bg-black antialiased">
      <button
        type="button"
        className="group relative z-40 inline-block h-[120px] w-[320px] cursor-pointer rounded-full bg-slate-800 p-px text-xs font-semibold leading-6 text-white no-underline  shadow-2xl shadow-zinc-900"
      >
